...
class Forager(GraphMatrix):
    def __init__(self, filename):
        ...
        self.preferred_tour = False  # whether a forager follows another forager or not
    ...
    def waggle_dance(self, A, d_i):
        '''
        :param A: waggle dance scaling factor
        :param d_i: profitability rating of solutions
        :return:
        '''
        #Waggle dance with duration D
        D = A*d_i
